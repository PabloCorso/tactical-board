...
- A **Player** uses its Object size as the single local marker frame for rendering, Selection, resize handles, and broad hit testing. Player Appearance renderers fit their complete solid painted output, including strokes, into that frame; decorative effects such as shadows may extend beyond it.
